...
BROKER = getattr(const, "mqtt_broker", "192.168.30.13")
PORT = getattr(const, "mqtt_port", 1883)
TOPIC_CMD = getattr(const, "mqtt_topic_cmd", "manejadora_am")
TOPIC_STATUS = getattr(const, "mqtt_topic_status", "manejadora_am_status")
CLIENT_ID = getattr(const, "controller_id", "eg628_am")
